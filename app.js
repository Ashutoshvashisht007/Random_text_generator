...
form.addEventListener('submit',(e)=>{
  // prevents default behaviour of form i.e, sending response to the server
  e.preventDefault();
  const value = parseInt(amount.value); // parsing because form returns a string value
